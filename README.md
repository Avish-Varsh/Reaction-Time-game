# Reaction-Time-game
<br>
This is a Reaction time game that utilises a led chaser to imporve the reaction time of the user in a fun manner. Along with helping begginers learn key arduino and coding concepts. 
<br>
